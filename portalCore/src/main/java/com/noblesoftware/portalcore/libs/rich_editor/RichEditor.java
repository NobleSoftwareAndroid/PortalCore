package com.noblesoftware.portalcore.libs.rich_editor;
...
public class RichEditor extends WebView {
    ...
    public void setFontTextSize(int fontSize) {
        exec("javascript:RE.setFontTextSize('" + fontSize + "');");
    }
    ...
    public void insertImageWithSize(String url, String alt, String width, String height, Boolean relative) {
        exec("javascript:RE.prepareInsert();");
    ...
    public void focusEditorText() {
        requestFocus();
        exec("javascript:RE.focusText();");
    }
