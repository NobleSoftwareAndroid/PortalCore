package com.noblesoftware.portalcore.libs.math_jax;
...
public class MathJaxView extends WebView {
   ...
   public MathJaxView(Context var1, AttributeSet var2) {
      super(var1, var2);
      TypedArray var3;
      String var4 = (var3 = this.getContext().obtainStyledAttributes(var2, R.styleable.MathJaxView)).getString(R.styleable.MathJaxView_android_text);
